...
//                             { 0.5774,  0.3333,  0.1925, -2.5641, -1.4804, 2.5641}};
   ...
   // Given the UAV arm length of 0.31 m and a prop. angle of 15 deg. while accounting for prop. torques
                                           ...
                                           double m, double g, double J[3][3], double f[6])
{
   ...
   // Given the UAV arm length of 0.31 m and a prop. angle of 15 deg. (Athena)
  // double invFMmat[6][6] = {  {-0.0000,    1.2879,   -0.1725,         0,    1.1132,    2.0773},
  //                            {-1.1154,    0.6440,    0.1725,    0.9641,   -0.5566,    2.0773},
  //                            {-1.1154,   -0.6440,   -0.1725,   -0.9641,   -0.5566,    2.0773},
  //                            {-0.0000,   -1.2879,    0.1725,    0.0000,    1.1132,    2.0773},
  //                            { 1.1154,   -0.6440,   -0.1725,    0.9641,   -0.5566,    2.0773},
  //                            { 1.1154,    0.6440,    0.1725,   -0.9641,   -0.5566,    2.0773}};
  ...
  //                             { -0.0000,   -1.2879,    0.1725,         0,    1.1132,    0.3071},
   ...
   // Given the UAV arm length of 0.31 m and a prop. angle of 15 deg. while accounting for prop. torques only in third body fixed axis
     double invFMmat[6][6] = {  { 0.0000,    1.2879,   -0.1725,   -0.0000,    1.1132,    0.9247},
                                {-1.1154,    0.6440,    0.1725,    0.9641,   -0.5566,    0.9247},
                                {-1.1154,   -0.6440,   -0.1725,   -0.9641,   -0.5566,    0.9247},
                                {-0.0000,   -1.2879,    0.1725,   -0.0000,    1.1132,    0.9247},
                                { 1.1154,   -0.6440,   -0.1725,    0.9641,   -0.5566,    0.9247},
                                { 1.1154,    0.6440,    0.1725,   -0.9641,   -0.5566,    0.9247}};
    ...
    double l = 0.0;// length of rod connecting to the spherical joint
...
//double invFMmat[6][6] = {{0.0000, 0.4082, -0.2887, -0.0000, 1.3169, 0.4656},
//                        {-0.3536, 0.2041, 0.2887, 1.1405, -0.6585, 0.4656},
//                        {-0.3536, -0.2041, -0.2887, -1.1405, -0.6585, 0.4656},
//                        {-0.0000, -0.4082, 0.2887, 0, 1.3169, 0.4656},
//                        {0.3536, -0.2041, -0.2887, 1.1405, -0.6585, 0.4656},
//                        {0.3536, 0.2041, 0.2887, -1.1405, -0.6585, 0.4656}};
